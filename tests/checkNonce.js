                          ...
                          if(choice === 2){
                              if(devName.includes("MBA")){
                                ...
                                dev = {
                                  ...
                                  browserVersion: "112.0.5615.29",
                                };
                                devices[devName] = dev
                               
                              
                              }else if(devName.includes("MBI")){
                    
                                dev = {
                                  name: devName,
                                  userAgent: "Mobile/6.0 (Mobile; iOS 14.1; FakeUA/2)",
                                  viewport: {
                                    width: 360,
                                    height: 640,
                                    deviceScaleFactor: 1,
                              ...
                              }else if(devName.includes("DBW")){
                    
                                dev = {
                                  name: devName,
                                  userAgent: "Desktop/114.0 (Windows NT 13.9; Windows; x32; FakeUA/6)",
                                  viewport: {
                                    width: 1280,
                                    height: 720,
                                    deviceScaleFactor: 1,
                              ...
                              }else if(devName.includes("DBM")){
                    
                                dev = {
                                  name: devName,
                                  userAgent: "Desktop/114.0 (Windows NT 13.9; macOS; x32; FakeUA/2)",
                                  viewport: {
                                    width: 1280,
                                    height: 720,
                                    deviceScaleFactor: 1,
                              ...
                              if(devName === "MobileMBA"){
                                  ua = "Mobile/1.0 (Android; 12.8)"
                              }else{
                                  ua = "Chrome/91.0 (Windows; 14.1)"
                              }
                              dev = {
                                  name: devName,
                                  userAgent: ua,
