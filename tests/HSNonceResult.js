...
let  numberOfHomePagesThatProvideSimilarNonceValueLikeSub = 0;
...
for(var e of array){
  ...
  numberOfHomePagesThatProvideSimilarNonceValueLikeSub = 0;
  homePagesThatProvideSimilarNonceValueLikeSub = new Array();
